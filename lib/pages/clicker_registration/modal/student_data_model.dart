class StudentDataModel {
  ...
  StudentDataModel copyWith(String clickerID){
    return StudentDataModel(sessionId: sessionId, onlineSessionId: onlineSessionId, instituteUserId: instituteUserId, onlineInstituteUserId: onlineInstituteUserId, instituteId: instituteId, instituteCourseId: instituteCourseId, className: className, name: name, gender: gender, email: email, mobile: mobile, clickerDeviceID: clickerID);
  }
}
