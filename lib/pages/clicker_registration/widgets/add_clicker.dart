  ...
  Widget build(BuildContext context) {
    return GestureDetector(
          ...
          return Center(child: Material(
            ...
            child: Container(
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    const Text("Generate Clickers",style: TextStyle(
                ...
                const SizedBox(height: 15,),
                  ...
                  onPressed: () {
                    if(formKey.currentState!.validate()){
                      Navigator.pop(context);
                      Get.find<ClickerRegistrationController>().generateClickers(int.parse(_clickerController.text));
                    }
            },
              child: const Text(
              ...
              style: ElevatedButton.styleFrom(
                padding: const EdgeInsets.symmetric(horizontal: 50, vertical: 20), // Optional: adjust padding for button size
              ),
            ),
      ...
      child: Container(
        ...
        child: Icon(Icons.add_circle_outline_rounded,size: 70,color: Colors.grey.shade300,),
      ),
    );
  }
}
